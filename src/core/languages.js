...
const translations = {
  en: {
    ...
    engineUrlHints: "The URL with {query} placeholder for your search term",
    addSearchEngine: "Add Search Engine",
    editSearchEngine: "Edit Search Engine",
    addEngine: "Add Engine",
    saveChanges: "Save Changes",
    noCustomEngines: "No custom search engines yet. Add one below.",
    editEngineBtn: "Edit",
    deleteEngineBtn: "Delete",
    enterEngineName: "Please enter a name for the search engine.",
    enterEngineUrl: "Please enter a search URL.",
    invalidEngineUrl: "Please enter a valid URL starting with http:// or https://.",
  ...
  zh: {
    ...
    engineUrl: "搜索网址",
    engineIcon: "图标网址（可选）",
    engineUrlHints: "包含 {query} 占位符的搜索网址",
    addSearchEngine: "添加搜索引擎",
    editSearchEngine: "编辑搜索引擎",
    addEngine: "添加引擎",
    saveChanges: "保存更改",
    noCustomEngines: "暂无自定义搜索引擎。在下方添加一个。",
    editEngineBtn: "编辑",
    deleteEngineBtn: "删除",
    enterEngineName: "请输入搜索引擎名称。",
    enterEngineUrl: "请输入搜索网址。",
    invalidEngineUrl: "请输入以 http:// 或 https:// 开头的有效网址。",
