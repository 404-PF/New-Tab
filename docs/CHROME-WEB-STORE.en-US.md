...
- A lightweight, clean, and highly customizable new tab page for Chromium users who want quick access to their favorite websites and tools.

> Note: This content matches the Chrome Web Store en-US locale and can be pasted into the Developer Dashboard listing fields.
